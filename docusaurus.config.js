...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: "/solution-trusteer-entra",


    // GitHub pages deployment config.
    // If you aren"t using GitHub pages, you don"t need these.
    organizationName: "ibm-client-engineering", // Usually your GitHub org/user name.
    projectName: "solution-trusteer-entra", // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-trusteer-entra/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-trusteer-entra/edit/main/${blogDirPath}/${blogPath}",
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-trusteer-entra",
